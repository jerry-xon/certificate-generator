...
const Generator = () => {
  ...
  // ✅ No word limit — instead we check box height dynamically
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-white px-4 py-10">
      ...
      <div className="flex flex-col lg:flex-row gap-10 max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-2/3 flex justify-center">
          ...
          >
            {/* Name */}
            <div className="absolute top-[40%] w-full text-center text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium text-black px-4 mb-2 sm:mb-4">
              {name}
            </div>
      ...
      <div className="absolute left-[-9999px]">
        ...
        >
          {/* Name */}
          <div className="absolute top-[39%] w-full text-center text-3xl font-medium text-black px-4 mb-4">
            {name}
          </div>
